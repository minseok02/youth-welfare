...
review_gate_policy_promotion_status = status.get("review_gate_policy_promotion_status", "")
review_gate_policy_promotion_reason = status.get("review_gate_policy_promotion_reason", "")
review_gate_policy_promotion_action_status = status.get("review_gate_policy_promotion_action_status", "")
review_gate_policy_promotion_action_reason = status.get("review_gate_policy_promotion_action_reason", "")
review_gate_policy_promotion_readiness_status = status.get("review_gate_policy_promotion_readiness_status", "")
review_gate_policy_promotion_readiness_reason = status.get("review_gate_policy_promotion_readiness_reason", "")
review_gate_policy_promotion_execution_status = status.get("review_gate_policy_promotion_execution_status", "")
review_gate_policy_promotion_execution_reason = status.get("review_gate_policy_promotion_execution_reason", "")
review_gate_policy_promotion_approval_criteria_status = status.get("review_gate_policy_promotion_approval_criteria_status", "")
review_gate_policy_promotion_approval_criteria_reason = status.get("review_gate_policy_promotion_approval_criteria_reason", "")
review_gate_policy_promotion_approval_status = status.get("review_gate_policy_promotion_approval_status", "")
review_gate_policy_promotion_approval_reason = status.get("review_gate_policy_promotion_approval_reason", "")
review_gate_policy_promotion_approval_decision_status = status.get("review_gate_policy_promotion_approval_decision_status", "")
review_gate_policy_promotion_approval_decision_reason = status.get("review_gate_policy_promotion_approval_decision_reason", "")
review_gate_policy_promotion_approval_record_status = status.get("review_gate_policy_promotion_approval_record_status", "")
review_gate_policy_promotion_approval_record_reason = status.get("review_gate_policy_promotion_approval_record_reason", "")
review_gate_policy_promotion_review_run_status = status.get("review_gate_policy_promotion_review_run_status", "")
...
review_gate_policy_promotion_review_run_approval_criteria_status = status.get("review_gate_policy_promotion_review_run_approval_criteria_status", "")
review_gate_policy_promotion_review_run_approval_criteria_reason = status.get("review_gate_policy_promotion_review_run_approval_criteria_reason", "")
review_gate_policy_promotion_review_run_approval_decision_status = status.get("review_gate_policy_promotion_review_run_approval_decision_status", "")
...
review_gate_policy_promotion_review_run_approval_record_transition_status = status.get("review_gate_policy_promotion_review_run_approval_record_transition_status", "")
review_gate_policy_promotion_review_run_approval_record_transition_reason = status.get("review_gate_policy_promotion_review_run_approval_record_transition_reason", "")
review_gate_policy_promotion_review_run_approval_record_write_status = status.get("review_gate_policy_promotion_review_run_approval_record_write_status", "")
review_gate_policy_promotion_review_run_approval_record_write_reason = status.get("review_gate_policy_promotion_review_run_approval_record_write_reason", "")
