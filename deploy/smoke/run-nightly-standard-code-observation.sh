...
export ACTIVE_BASELINE_RUN_FRONTEND_E2E="${ACTIVE_BASELINE_RUN_FRONTEND_E2E:-false}"
export ACTIVE_BASELINE_RUN_OPS_OBSERVATION="${ACTIVE_BASELINE_RUN_OPS_OBSERVATION:-false}"
