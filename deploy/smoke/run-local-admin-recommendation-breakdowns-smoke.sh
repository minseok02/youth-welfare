...
echo "review_gate_primary_reference_mode=${BREAKDOWN_VALUES[47]}"
echo "review_gate_example_target_top1_users=${BREAKDOWN_VALUES[48]}"
echo "review_gate_example_target_top1_last_24h=${BREAKDOWN_VALUES[49]}"
echo "review_gate_real_user_latest_users=${BREAKDOWN_VALUES[50]}"
echo "review_gate_real_user_target_top1_users=${BREAKDOWN_VALUES[51]}"
echo "recent_window_hours=${BREAKDOWN_VALUES[52]}"
echo "recent_window_target_service_id=${BREAKDOWN_VALUES[53]}"
echo "recent_window_latest_batch_users=${BREAKDOWN_VALUES[54]}"
echo "recent_window_real_user_users=${BREAKDOWN_VALUES[55]}"
echo "recent_window_top1_leader_service_id=${BREAKDOWN_VALUES[56]}"
echo "recent_window_top1_leader_real_user_users=${BREAKDOWN_VALUES[57]}"
echo "recent_window_target_top1_users=${BREAKDOWN_VALUES[58]}"
echo "recent_window_target_top1_real_user_users=${BREAKDOWN_VALUES[59]}"
