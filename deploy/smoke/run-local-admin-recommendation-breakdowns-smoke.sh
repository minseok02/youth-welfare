...
echo "review_gate_policy_promotion_approval_status=${BREAKDOWN_VALUES[51]}"
echo "review_gate_policy_promotion_approval_reason=${BREAKDOWN_VALUES[52]}"
echo "review_gate_primary_reference_mode=${BREAKDOWN_VALUES[53]}"
echo "review_gate_example_target_top1_users=${BREAKDOWN_VALUES[54]}"
echo "review_gate_example_target_top1_last_24h=${BREAKDOWN_VALUES[55]}"
echo "review_gate_real_user_latest_users=${BREAKDOWN_VALUES[56]}"
echo "review_gate_real_user_target_top1_users=${BREAKDOWN_VALUES[57]}"
echo "recent_window_hours=${BREAKDOWN_VALUES[58]}"
echo "recent_window_target_service_id=${BREAKDOWN_VALUES[59]}"
echo "recent_window_latest_batch_users=${BREAKDOWN_VALUES[60]}"
echo "recent_window_real_user_users=${BREAKDOWN_VALUES[61]}"
echo "recent_window_top1_leader_service_id=${BREAKDOWN_VALUES[62]}"
echo "recent_window_top1_leader_real_user_users=${BREAKDOWN_VALUES[63]}"
echo "recent_window_target_top1_users=${BREAKDOWN_VALUES[64]}"
echo "recent_window_target_top1_real_user_users=${BREAKDOWN_VALUES[65]}"
