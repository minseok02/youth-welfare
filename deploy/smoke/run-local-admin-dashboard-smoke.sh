...
echo "recommendation_review_gate_policy_promotion_approval_status=${DASHBOARD_VALUES[44]}"
echo "recommendation_review_gate_policy_promotion_approval_reason=${DASHBOARD_VALUES[45]}"
echo "recommendation_review_gate_primary_reference_mode=${DASHBOARD_VALUES[46]}"
echo "recommendation_review_gate_example_target_top1_users=${DASHBOARD_VALUES[47]}"
echo "recommendation_review_gate_example_target_top1_last_24h=${DASHBOARD_VALUES[48]}"
echo "recommendation_review_gate_real_user_latest_users=${DASHBOARD_VALUES[49]}"
echo "recommendation_review_gate_real_user_target_top1_users=${DASHBOARD_VALUES[50]}"
echo "recommendation_recent_window_hours=${DASHBOARD_VALUES[51]}"
echo "recommendation_recent_window_target_service_id=${DASHBOARD_VALUES[52]}"
echo "recommendation_recent_window_latest_batch_users=${DASHBOARD_VALUES[53]}"
echo "recommendation_recent_window_real_user_users=${DASHBOARD_VALUES[54]}"
echo "recommendation_recent_window_top1_leader_service_id=${DASHBOARD_VALUES[55]}"
echo "recommendation_recent_window_top1_leader_real_user_users=${DASHBOARD_VALUES[56]}"
echo "recommendation_recent_window_target_top1_users=${DASHBOARD_VALUES[57]}"
echo "recommendation_recent_window_target_top1_real_user_users=${DASHBOARD_VALUES[58]}"
