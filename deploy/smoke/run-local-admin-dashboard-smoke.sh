...
assert isinstance(data["notification"]["unreadAlerts"], int), "notification.unreadAlerts must be int"
assert isinstance(data["notification"]["retryableFailedNotifications"], int), "notification.retryableFailedNotifications must be int"
assert isinstance(data["notification"]["terminalFailedNotifications"], int), "notification.terminalFailedNotifications must be int"
...
print(data["notification"]["unreadAlerts"])
print(data["notification"]["retryableFailedNotifications"])
print(data["notification"]["terminalFailedNotifications"])
...
echo "notification_unread_alerts=${DASHBOARD_VALUES[29]}"
echo "notification_retryable_failed_notifications=${DASHBOARD_VALUES[30]}"
echo "notification_terminal_failed_notifications=${DASHBOARD_VALUES[31]}"
echo "search_zero_result_searches_in_window=${DASHBOARD_VALUES[32]}"
echo "user_pii_sync_pending_count=${DASHBOARD_VALUES[33]}"
echo "user_pii_sync_failed_count=${DASHBOARD_VALUES[34]}"
echo "user_pii_sync_synced_count=${DASHBOARD_VALUES[35]}"
echo "summary_window_days=${DASHBOARD_VALUES[36]}"
echo "collect_trend_windows=${DASHBOARD_VALUES[37]}"
echo "recommendation_recent_window_review_reading=${DASHBOARD_VALUES[38]}"
echo "recommendation_historical_example_dominance_detected=${DASHBOARD_VALUES[39]}"
echo "recommendation_review_gate_policy_candidate_status=${DASHBOARD_VALUES[40]}"
echo "recommendation_review_gate_policy_candidate_reason=${DASHBOARD_VALUES[41]}"
echo "recommendation_review_gate_policy_promotion_status=${DASHBOARD_VALUES[42]}"
echo "recommendation_review_gate_policy_promotion_reason=${DASHBOARD_VALUES[43]}"
echo "recommendation_review_gate_policy_promotion_action_status=${DASHBOARD_VALUES[44]}"
echo "recommendation_review_gate_policy_promotion_action_reason=${DASHBOARD_VALUES[45]}"
echo "recommendation_review_gate_policy_promotion_readiness_status=${DASHBOARD_VALUES[46]}"
echo "recommendation_review_gate_policy_promotion_readiness_reason=${DASHBOARD_VALUES[47]}"
echo "recommendation_review_gate_policy_promotion_execution_status=${DASHBOARD_VALUES[48]}"
echo "recommendation_review_gate_policy_promotion_execution_reason=${DASHBOARD_VALUES[49]}"
echo "recommendation_review_gate_policy_promotion_approval_criteria_status=${DASHBOARD_VALUES[50]}"
echo "recommendation_review_gate_policy_promotion_approval_criteria_reason=${DASHBOARD_VALUES[51]}"
echo "recommendation_review_gate_policy_promotion_approval_status=${DASHBOARD_VALUES[52]}"
echo "recommendation_review_gate_policy_promotion_approval_reason=${DASHBOARD_VALUES[53]}"
echo "recommendation_review_gate_policy_promotion_approval_decision_status=${DASHBOARD_VALUES[54]}"
echo "recommendation_review_gate_policy_promotion_approval_decision_reason=${DASHBOARD_VALUES[55]}"
echo "recommendation_review_gate_policy_promotion_approval_record_status=${DASHBOARD_VALUES[56]}"
echo "recommendation_review_gate_policy_promotion_approval_record_reason=${DASHBOARD_VALUES[57]}"
echo "recommendation_review_gate_policy_promotion_review_run_status=${DASHBOARD_VALUES[58]}"
echo "recommendation_review_gate_policy_promotion_review_run_reason=${DASHBOARD_VALUES[59]}"
echo "recommendation_review_gate_policy_promotion_review_run_criteria_status=${DASHBOARD_VALUES[60]}"
echo "recommendation_review_gate_policy_promotion_review_run_criteria_reason=${DASHBOARD_VALUES[61]}"
echo "recommendation_review_gate_policy_promotion_review_run_decision_status=${DASHBOARD_VALUES[62]}"
echo "recommendation_review_gate_policy_promotion_review_run_decision_reason=${DASHBOARD_VALUES[63]}"
echo "recommendation_review_gate_policy_promotion_review_run_approval_criteria_status=${DASHBOARD_VALUES[64]}"
echo "recommendation_review_gate_policy_promotion_review_run_approval_criteria_reason=${DASHBOARD_VALUES[65]}"
echo "recommendation_review_gate_policy_promotion_review_run_approval_decision_status=${DASHBOARD_VALUES[66]}"
echo "recommendation_review_gate_policy_promotion_review_run_approval_decision_reason=${DASHBOARD_VALUES[67]}"
echo "recommendation_review_gate_policy_promotion_review_run_approval_status=${DASHBOARD_VALUES[68]}"
echo "recommendation_review_gate_policy_promotion_review_run_approval_reason=${DASHBOARD_VALUES[69]}"
echo "recommendation_review_gate_policy_promotion_review_run_approval_record_criteria_status=${DASHBOARD_VALUES[70]}"
echo "recommendation_review_gate_policy_promotion_review_run_approval_record_criteria_reason=${DASHBOARD_VALUES[71]}"
echo "recommendation_review_gate_policy_promotion_review_run_approval_record_status=${DASHBOARD_VALUES[72]}"
echo "recommendation_review_gate_policy_promotion_review_run_approval_record_reason=${DASHBOARD_VALUES[73]}"
echo "recommendation_review_gate_policy_promotion_review_run_approval_record_transition_status=${DASHBOARD_VALUES[74]}"
echo "recommendation_review_gate_policy_promotion_review_run_approval_record_transition_reason=${DASHBOARD_VALUES[75]}"
echo "recommendation_review_gate_policy_promotion_review_run_approval_record_write_status=${DASHBOARD_VALUES[76]}"
echo "recommendation_review_gate_policy_promotion_review_run_approval_record_write_reason=${DASHBOARD_VALUES[77]}"
echo "recommendation_review_gate_primary_reference_mode=${DASHBOARD_VALUES[78]}"
echo "recommendation_review_gate_example_target_top1_users=${DASHBOARD_VALUES[79]}"
echo "recommendation_review_gate_example_target_top1_last_24h=${DASHBOARD_VALUES[80]}"
echo "recommendation_review_gate_real_user_latest_users=${DASHBOARD_VALUES[81]}"
echo "recommendation_review_gate_real_user_target_top1_users=${DASHBOARD_VALUES[82]}"
echo "recommendation_recent_window_hours=${DASHBOARD_VALUES[83]}"
echo "recommendation_recent_window_target_service_id=${DASHBOARD_VALUES[84]}"
echo "recommendation_recent_window_latest_batch_users=${DASHBOARD_VALUES[85]}"
echo "recommendation_recent_window_real_user_users=${DASHBOARD_VALUES[86]}"
echo "recommendation_recent_window_top1_leader_service_id=${DASHBOARD_VALUES[87]}"
echo "recommendation_recent_window_top1_leader_real_user_users=${DASHBOARD_VALUES[88]}"
echo "recommendation_recent_window_target_top1_users=${DASHBOARD_VALUES[89]}"
echo "recommendation_recent_window_target_top1_real_user_users=${DASHBOARD_VALUES[90]}"
