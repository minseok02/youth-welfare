...
validate_env() {
  ...
  require_non_empty RECOMMENDATION_PERSISTENCE_COMMAND_DB_URL "${RECOMMENDATION_PERSISTENCE_COMMAND_DB_URL:-}"
  ...
  assert_equals DB_RECOMMENDATION_PERSISTENCE_COMMAND_USERNAME "${DB_RECOMMENDATION_PERSISTENCE_COMMAND_USERNAME}" "recommendation_persistence_command_rw"
  ...
  assert_runtime_core_target RECOMMENDATION_PERSISTENCE_COMMAND_DB_URL "${RECOMMENDATION_PERSISTENCE_COMMAND_DB_URL}"
...
- RECOMMENDATION_PERSISTENCE_COMMAND_DB_URL target: $(describe_runtime_target RECOMMENDATION_PERSISTENCE_COMMAND_DB_URL "${RECOMMENDATION_PERSISTENCE_COMMAND_DB_URL}")
...
- DB_RECOMMENDATION_PERSISTENCE_COMMAND_USERNAME: ${DB_RECOMMENDATION_PERSISTENCE_COMMAND_USERNAME}
...
- DB_RECOMMENDATION_PERSISTENCE_COMMAND_PASSWORD: $(password_state "${DB_RECOMMENDATION_PERSISTENCE_COMMAND_PASSWORD:-}")
