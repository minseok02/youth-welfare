...
if review_gate_policy_promotion_review_run_decision_status == "BOUNDED_PROMOTION_REVIEW_RUN_DECISION_NOT_READY":
    review_gate_policy_promotion_review_run_approval_status = "BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_NOT_READY"
    review_gate_policy_promotion_review_run_approval_reason = review_gate_policy_promotion_review_run_decision_reason
elif review_gate_policy_promotion_review_run_decision_status == "AWAIT_BOUNDED_PROMOTION_REVIEW_RUN_DECISION":
    review_gate_policy_promotion_review_run_approval_status = "PENDING_BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL"
    review_gate_policy_promotion_review_run_approval_reason = "REVIEW_RUN_APPROVAL_DECISION_PENDING_BECAUSE_APPROVAL_RECORD_NOT_WRITTEN"
elif review_gate_policy_promotion_review_run_decision_status == "BOUNDED_PROMOTION_REVIEW_RUN_APPROVED":
...
if review_gate_policy_promotion_review_run_approval_criteria_status == "NOT_READY_FOR_BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL":
    review_gate_policy_promotion_review_run_approval_decision_status = "BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_DECISION_NOT_READY"
    review_gate_policy_promotion_review_run_approval_decision_reason = review_gate_policy_promotion_review_run_approval_criteria_reason
elif review_gate_policy_promotion_review_run_approval_status == "PENDING_BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL":
...
elif review_gate_policy_promotion_review_run_approval_status == "APPROVED_FOR_BOUNDED_PROMOTION_REVIEW_RUN":
    review_gate_policy_promotion_review_run_approval_decision_status = "BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_APPROVED"
    review_gate_policy_promotion_review_run_approval_decision_reason = "REVIEW_RUN_APPROVAL_SUPPORTS_EXECUTION"

review_gate_policy_promotion_review_run_approval_record_status = "BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_RECORD_NOT_APPLICABLE"
review_gate_policy_promotion_review_run_approval_record_reason = review_gate_policy_promotion_review_run_approval_decision_reason
if review_gate_policy_promotion_review_run_approval_decision_status == "BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_DECISION_NOT_READY":
    review_gate_policy_promotion_review_run_approval_record_status = "BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_RECORD_NOT_READY"
    review_gate_policy_promotion_review_run_approval_record_reason = review_gate_policy_promotion_review_run_approval_decision_reason
elif review_gate_policy_promotion_review_run_approval_decision_status == "AWAIT_BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_DECISION":
...
elif review_gate_policy_promotion_review_run_approval_decision_status == "BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_APPROVED":
    review_gate_policy_promotion_review_run_approval_record_status = "BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_RECORDED"
    review_gate_policy_promotion_review_run_approval_record_reason = "REVIEW_RUN_APPROVAL_RECORD_SUPPORTS_EXECUTION"

review_gate_policy_promotion_review_run_approval_record_transition_status = "BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_RECORD_TRANSITION_NOT_APPLICABLE"
review_gate_policy_promotion_review_run_approval_record_transition_reason = review_gate_policy_promotion_review_run_approval_record_reason
if review_gate_policy_promotion_review_run_approval_record_criteria_status != "READY_FOR_BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_RECORD":
    review_gate_policy_promotion_review_run_approval_record_transition_status = "BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_RECORD_TRANSITION_NOT_READY"
    review_gate_policy_promotion_review_run_approval_record_transition_reason = review_gate_policy_promotion_review_run_approval_record_criteria_reason
elif review_gate_policy_promotion_review_run_approval_record_status == "PENDING_BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_RECORD":
...
elif review_gate_policy_promotion_review_run_approval_record_status == "BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_RECORDED":
    review_gate_policy_promotion_review_run_approval_record_transition_status = "BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_RECORD_WRITTEN"
    review_gate_policy_promotion_review_run_approval_record_transition_reason = "APPROVAL_RECORD_WRITTEN_AND_REVIEW_RUN_CAN_ADVANCE"

review_gate_policy_promotion_review_run_approval_record_write_status = "BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_RECORD_WRITE_NOT_APPLICABLE"
review_gate_policy_promotion_review_run_approval_record_write_reason = review_gate_policy_promotion_review_run_approval_record_transition_reason
if review_gate_policy_promotion_review_run_approval_record_transition_status == "BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_RECORD_TRANSITION_NOT_READY":
    review_gate_policy_promotion_review_run_approval_record_write_status = "BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_RECORD_WRITE_NOT_READY"
    review_gate_policy_promotion_review_run_approval_record_write_reason = review_gate_policy_promotion_review_run_approval_record_transition_reason
elif review_gate_policy_promotion_review_run_approval_record_transition_status == "AWAIT_BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_RECORD_WRITE":
...
elif review_gate_policy_promotion_review_run_approval_record_transition_status == "BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_RECORD_WRITTEN":
    review_gate_policy_promotion_review_run_approval_record_write_status = "BOUNDED_PROMOTION_REVIEW_RUN_APPROVAL_RECORD_WRITE_COMPLETED"
    review_gate_policy_promotion_review_run_approval_record_write_reason = "APPROVAL_RECORD_WRITE_COMPLETED_AND_REVIEW_RUN_CAN_ADVANCE"
...
lines = [
    ...
    f"- review_gate_policy_promotion_review_run_approval_decision_status: `{review_gate_policy_promotion_review_run_approval_decision_status}`",
    ...
    f"- review_gate_policy_promotion_review_run_approval_record_transition_status: `{review_gate_policy_promotion_review_run_approval_record_transition_status}`",
    f"- review_gate_policy_promotion_review_run_approval_record_transition_reason: `{review_gate_policy_promotion_review_run_approval_record_transition_reason}`",
    f"- review_gate_policy_promotion_review_run_approval_record_write_status: `{review_gate_policy_promotion_review_run_approval_record_write_status}`",
    f"- review_gate_policy_promotion_review_run_approval_record_write_reason: `{review_gate_policy_promotion_review_run_approval_record_write_reason}`",
...
json_payload = {
    ...
    "review_gate_context": {
        ...
        "review_gate_policy_promotion_review_run_approval_decision_status": review_gate_policy_promotion_review_run_approval_decision_status,
        ...
        "review_gate_policy_promotion_review_run_approval_record_transition_status": review_gate_policy_promotion_review_run_approval_record_transition_status,
        "review_gate_policy_promotion_review_run_approval_record_transition_reason": review_gate_policy_promotion_review_run_approval_record_transition_reason,
        "review_gate_policy_promotion_review_run_approval_record_write_status": review_gate_policy_promotion_review_run_approval_record_write_status,
        "review_gate_policy_promotion_review_run_approval_record_write_reason": review_gate_policy_promotion_review_run_approval_record_write_reason,
