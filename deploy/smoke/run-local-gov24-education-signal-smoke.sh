...
SMOKE_EMAIL_PREFIX="${SMOKE_EMAIL_PREFIX:-gov24.education.signal}"
SMOKE_NAME="${SMOKE_NAME:-교육신호점검}"
SMOKE_BIRTH_DATE="${SMOKE_BIRTH_DATE:-2005-03-15}"
SMOKE_SIDO="${SMOKE_SIDO:-경기도}"
SMOKE_SGG="${SMOKE_SGG:-안산시}"
...
SMOKE_INTEREST_FIELD="${SMOKE_INTEREST_FIELD:-교육·직업훈련}"
SMOKE_PRIORITY_CODE="${SMOKE_PRIORITY_CODE:-EDUCATION}"
TARGET_SERVICE_ID="${TARGET_SERVICE_ID:-7193}"
