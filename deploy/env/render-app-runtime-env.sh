...
allowlist=(
  ...
  DB_ADMIN_RO_POOL_MIN_IDLE
  DB_ADMIN_RO_USERNAME
  DB_APP_PII_PASSWORD
  DB_APP_PII_POOL_MAX_SIZE
  DB_APP_PII_POOL_MIN_IDLE
  DB_APP_PII_USERNAME
  DB_CHAT_SESSION_CLEANUP_PASSWORD
  DB_CHAT_SESSION_CLEANUP_POOL_MAX_SIZE
  DB_CHAT_SESSION_CLEANUP_POOL_MIN_IDLE
  DB_CHAT_SESSION_CLEANUP_USERNAME
  DB_CLUSTER_AI_CLEANUP_PASSWORD
  DB_CLUSTER_AI_CLEANUP_POOL_MAX_SIZE
  DB_CLUSTER_AI_CLEANUP_POOL_MIN_IDLE
  DB_CLUSTER_AI_CLEANUP_USERNAME
  DB_COLLECT_EXECUTION_LOCK_CLEANUP_PASSWORD
  DB_COLLECT_EXECUTION_LOCK_CLEANUP_POOL_MAX_SIZE
  DB_COLLECT_EXECUTION_LOCK_CLEANUP_POOL_MIN_IDLE
  DB_COLLECT_EXECUTION_LOCK_CLEANUP_USERNAME
  DB_NOTIFICATION_PII_RO_PASSWORD
  DB_NOTIFICATION_PII_RO_POOL_MAX_SIZE
  DB_NOTIFICATION_PII_RO_POOL_MIN_IDLE
  DB_NOTIFICATION_PII_RO_USERNAME
  DB_PASSWORD
  DB_POOL_MAX_SIZE
  DB_POOL_MIN_IDLE
  DB_RECOMMENDATION_PERSISTENCE_COMMAND_PASSWORD
  DB_RECOMMENDATION_PERSISTENCE_COMMAND_POOL_MAX_SIZE
  DB_RECOMMENDATION_PERSISTENCE_COMMAND_POOL_MIN_IDLE
  DB_RECOMMENDATION_PERSISTENCE_COMMAND_USERNAME
  DB_RECOMMENDATION_RETENTION_CLEANUP_PASSWORD
  DB_RECOMMENDATION_RETENTION_CLEANUP_POOL_MAX_SIZE
  DB_RECOMMENDATION_RETENTION_CLEANUP_POOL_MIN_IDLE
  DB_RECOMMENDATION_RETENTION_CLEANUP_USERNAME
  DB_RECOMMENDATION_REVIEW_GATE_COMMAND_PASSWORD
  DB_RECOMMENDATION_REVIEW_GATE_COMMAND_POOL_MAX_SIZE
  DB_RECOMMENDATION_REVIEW_GATE_COMMAND_POOL_MIN_IDLE
  DB_RECOMMENDATION_REVIEW_GATE_COMMAND_USERNAME
  DB_URL
  DB_USERNAME
  DB_WEB_PUSH_SUBSCRIPTION_CLEANUP_PASSWORD
  DB_WEB_PUSH_SUBSCRIPTION_CLEANUP_POOL_MAX_SIZE
  DB_WEB_PUSH_SUBSCRIPTION_CLEANUP_POOL_MIN_IDLE
  ...
  OBSERVABILITY_LOG_RETENTION_CRON
  OBSERVABILITY_LOG_RETENTION_DAYS
  OBSERVABILITY_LOG_RETENTION_ZONE
  ...
  USER_PII_SYNC_RETENTION_CRON
  USER_PII_SYNC_RETENTION_ENABLED
  USER_PII_SYNC_RETENTION_SYNCED_DAYS
  USER_PII_SYNC_RETENTION_ZONE
