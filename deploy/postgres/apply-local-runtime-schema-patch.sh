...
RECOMMENDATION_PERSISTENCE_COMMAND_USERNAME="${DB_RECOMMENDATION_PERSISTENCE_COMMAND_USERNAME:-$(load_env_value DB_RECOMMENDATION_PERSISTENCE_COMMAND_USERNAME recommendation_persistence_command_rw)}"
RECOMMENDATION_PERSISTENCE_COMMAND_PASSWORD="${DB_RECOMMENDATION_PERSISTENCE_COMMAND_PASSWORD:-$(load_env_value DB_RECOMMENDATION_PERSISTENCE_COMMAND_PASSWORD "${DB_PASSWORD_VALUE}")}"
