...
GRANT CONNECT ON DATABASE ${db_name} TO ${app_username}, ${app_pii_username}, ${notification_ro_username}, ${migration_username};

GRANT USAGE ON SCHEMA public TO ${app_username}, ${migration_username};
