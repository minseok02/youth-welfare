...
- `2026-05-15`: Gov24 `detail/supportConditions` backlog closeout을 마쳐 현재 `list=10937`, `detail=10937`, `support raw=10937` 까지 전부 채웠다. `supportConditions` facts 는 `163743` row, 서비스 기준 coverage `9959 / 10937 (91.1%)` 이고, 남은 `978`건은 raw payload는 있지만 샘플 기준 `conditions` 값이 전부 `null` 인 케이스가 대부분이다.
