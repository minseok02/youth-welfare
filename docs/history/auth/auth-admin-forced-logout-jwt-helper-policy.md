...
future `admin forced logout` 구현을 위해 [JwtUtil.java](../../../backend/src/main/java/com/example/welfare/global/util/JwtUtil.java) 에 아래 helper/claim 계약을 추가하는 방향으로 고정한다.
