...
현재 `logout` presented-token revoke는 [JwtAuthenticationFilter.java](../../../backend/src/main/java/com/example/welfare/global/config/JwtAuthenticationFilter.java) 에서:
