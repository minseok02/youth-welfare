...
|--------|---------|----------|----------|
| 표 1 | 프로젝트 필요성 관련 정책·연구 근거 | `제1장 제1절 프로젝트 필요성 및 배경` | 관련 보고서와 프로젝트 필요성을 연결 |
| 표 2 | 관련 기술 및 선행연구 요약 | `제1장 제2절 관련 기술 및 선행연구` | 관련 기술, 연구, 프로젝트 적용 내용을 요약 |
| 표 3 | 구현 환경 | `제2장 제3절 1. 구현 환경` | 한글 표 기능으로 작성 |
| 표 4 | 외부 API 및 연동 서비스 사용 내역 | `제2장 제3절 2. 외부 API 및 연동 서비스 사용 내역` | 한글 표 기능으로 작성 |
| 표 5 | 주요 내부 API 엔드포인트 | `제2장 제3절 3. 주요 내부 API 엔드포인트` | 필요 시 본문 또는 부록에 배치 |
| 표 6 | 테스트 및 검증 결과 | `제3장 제2절 테스트 및 검증 결과` | 한글 표 기능으로 작성 |
| 표 7 | 운영 환경 응답성 검증 요약 | `제3장 제2절 테스트 및 검증 결과` | 검증 보조 자료로 짧게 배치 |
