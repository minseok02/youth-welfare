...
3. 필요하면 [runtime-api-smoke-commands.md](./runtime-api-smoke-commands.md)

### 기록을 남길 때

1. [collect-incident-template.md](./collect-incident-template.md)
2. [phase-plan.md](./phase-plan.md)
3. 필요하면 [troubleshooting-log.md](./troubleshooting-log.md)
...
4. 기록은 [collect-incident-template.md](./collect-incident-template.md) 를 기준으로 남깁니다.
