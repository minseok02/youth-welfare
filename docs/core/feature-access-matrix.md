...
- [SecurityConfig.java](../../backend/src/main/java/com/example/welfare/global/config/SecurityConfig.java)
- [AuthAdminRoleService.java](../../backend/src/main/java/com/example/welfare/user/service/AuthAdminRoleService.java)
- [RecommendationController.java](../../backend/src/main/java/com/example/welfare/recommend/controller/RecommendationController.java)
- [ChatSessionController.java](../../backend/src/main/java/com/example/welfare/chat/controller/ChatSessionController.java)
- [router/index.jsx](../../frontend/src/router/index.jsx)
- [RequireLogin.jsx](../../frontend/src/components/RequireLogin.jsx)
- [Header.jsx](../../frontend/src/components/Header.jsx)
- [FloatingNav.jsx](../../frontend/src/components/FloatingNav.jsx)
